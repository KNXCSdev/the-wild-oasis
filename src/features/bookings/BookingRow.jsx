...
function BookingRow({
  ...
  const { deleteSelectedBooking, isDeletingBooking } = useDeleteBooking();
      ...
      <Modal>
        <Menus.Menu>
          ...
          <Menus.List id={bookingId}>
            ...
            {status === "checked-in" && (
              <Menus.Button icon={<HiArrowUpOnSquare />} onClick={() => handleCheckOut(bookingId)}>
                Check out
              </Menus.Button>
            )}
        ...
        <Modal.Window name="delete">
          <ConfirmDelete
            ...
            onConfirm={() => deleteSelectedBooking(bookingId)}
          />
        </Modal.Window>
      </Modal>
    </Table.Row>
